...
export PATH="/projappl/project_2019895/master-thesis/RoomFormer/environments/bin:$PATH"

export PYTHONUSERBASE=/projappl/project_2019895/master-thesis/RoomFormer/environments/
