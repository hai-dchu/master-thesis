...
# Copied from dinov3/dinov3/eval/segmentation/heads/linear_head.py
class LinearHead(nn.Module):
    ...
    def __init__(
        ...
        self.batchnorm_layer = (
            ...
            if use_batchnorm
            else nn.Identity(self.channels)
        )
        self.conv = nn.Conv2d(
            self.channels, self.n_output_channels, kernel_size=1, padding=0, stride=1
        )
    ...
    def predict(self, x, rescale_to=(256, 256)):
        """
