...
def build(args, train=True):
    ...
    dinov3 = torch.hub.load(args.dinov3_repo, 'dinov3_vits16', source='local', weights=args.dinov3_checkpoint) #.to(args.device)
    dinov3_feature_extractor = DinoImageFeature(dinov3, img_size=256)
