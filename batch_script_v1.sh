...
echo "
Batch script for roihu to train modified RoomFormer (v1)
in which dino features are stacked onto the 2D projection
before passing through the rest of RoomFormer.
"
...
python main_v1.py --dataset_name=stru3d \
               ...
               --wandb \
               --output_dir='/scratch/project_2019597/master-thesis/output-v1'
